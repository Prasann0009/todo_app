...
const sendVerificationMail = (email, token) => {
  ...
  const transporter = nodemailer.createTransport({
    ...
    service: "gmail",
    auth: {
      user: "akshujain0009@gmail.com",
      pass: "cpandsrfwohwidvh",
    },
  });

  const mailOptions = {
    from: "akshujain0009@gmail.com",
    to: email,
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
              <tr>
                <td style="color: #00adb5; font-family: Arial, sans-serif;">
                  ...
                  <h3 style="font-size: 24px; margin: 0; text-align:center; "color: #00adb5;  font-family: Montserrat, sans-serif;">Verify Your Email</h3>
                </td>
              </tr>
              <tr>
                <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                <a href="${process.env.URL}/verify/${token}" style=" border: none;
